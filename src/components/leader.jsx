...
const Leader = () => {
  ...
  const leaderboardData = [
    { year: 'Second', name: 'Madhusudan Tiwari', score: 0 },
    { year: 'Second', name: 'Shivam', score: 0 },
    { year: 'Third', name: 'Prateek Gaur', score: 0 },
    { year: 'Third', name: 'Himanshi Sharma', score: 0 },
    { year: 'Third', name: 'Hemant Choudhary', score: 0 },
    { year: 'Second', name: 'Singh Ayushraj', score: 0 },
    { year: 'Second', name: 'Sumit Sharma', score: 0 },
    { year: 'Second', name: 'Hardik Vijay', score: 0 },
    { year: 'Second', name: 'Siya Jhanwar', score: 0 },
    { year: 'Second', name: 'Mahima Jain', score: 0 },
    { year: 'Second', name: 'Vedansh ', score: 0 },
    { year: 'Second', name: 'Vikas Sharma', score: 0 },
    { year: 'Third', name: 'Priyanka Yadav', score: 0 },
    { year: 'Second', name: 'Mohit Choudhary', score: 0 },
    { year: 'Second', name: 'Priyanshu Yadav', score: 0 },
    { year: 'Second', name: 'Krishan Yadav', score: 0 },
    { year: 'Second', name: 'Nitin Nareda', score: 0 },
    { year: 'Third', name: 'Mahesh Gurjar', score: 0 },
    { year: 'Third', name: 'Suresh Soni', score: 0 },
    { year: 'Second', name: 'Sachin', score: 0 },
    { year: 'Second', name: 'Chetanya Sharma', score: 0 },
    { year: 'Second', name: 'Manvendra Singh', score: 0 },
    { year: 'Second', name: 'Hemant Sharma', score: 0 },
    { year: 'Second', name: 'Sonu', score: 0 },
    { year: 'Second', name: 'Devid Joshi', score: 0 },
    { year: 'Second', name: 'Harmeet singh', score: 0 },
    { year: 'Second', name: 'Satyendra Saini', score: 0 },
    { year: 'Second', name: 'Danish Khan', score: 0 },
    { year: 'Second', name: 'Aditya Singh', score: 0 },
    { year: 'Second', name: 'Hrishabh', score: 0 },
    { year: 'Second', name: 'Dhruv Sharma', score: 0 },
    { year: 'Second', name: 'Lakshay Beria', score: 0 },
    { year: 'Second', name: 'Rajveer Singh', score: 0 },
    { year: 'Second', name: 'Tarun Sharma', score: 0 },
    { year: 'Second', name: 'Vijay', score: 0 },
    { year: 'Second', name: 'Mahendra', score: 0 },
  ]
